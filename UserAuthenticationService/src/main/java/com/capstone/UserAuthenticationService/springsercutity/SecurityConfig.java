package com.capstone.UserAuthenticationService.springsercutity;
...
//        http.authorizeHttpRequests((authorize) -> authorize.anyRequest().requestMatchers("/actuator/**").permitAll().authenticated())
...
//                .formLogin(Customizer.withDefaults());
    ...
    //user screen -> password -> bpe.encode(password) == en(pasword)
    //if(user== && paasword==)
   /* @Bean

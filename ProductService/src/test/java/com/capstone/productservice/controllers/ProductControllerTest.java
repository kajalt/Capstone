...
class ProductControllerTest {
    ...
    public void Test_GetProduct_WithValidId_ReturnsProductSuccessfully() {
        ...
        assertEquals(1000D,productResponseEntity.getBody().getProductPrice());
        assertEquals("Iphone",productResponseEntity.getBody().getProductName());
    }
